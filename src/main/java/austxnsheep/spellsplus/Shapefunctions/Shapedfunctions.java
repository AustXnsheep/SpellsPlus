...
public class Shapedfunctions {
    ...
    public void test(Integer radius, Location center, int corners, float yaw, Particle particle) {
    ...
    public void drawLineWithCurves(Location start, Location end, int numSegments, Particle particle) {
